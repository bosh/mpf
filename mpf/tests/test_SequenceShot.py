...
class TestShots(MpfTestCase):
    ...
    def test_sequence_with_duplicates_reg_once(self):
    ...
    def test_sequence_with_duplicates(self):
        self.mock_event("sequence_with_dupes_hit")
        self.post_event("event_1")
        self.machine_run()
        self.post_event("event_2")
        self.machine_run()
        self.post_event("event_1")
        self.machine_run()
        self.post_event("event_3")
        self.machine_run()
        self.assertEventCalled("sequence_with_dupes_hit", 0)
        self.post_event("event_1")
        self.machine_run()
        self.assertEventCalled("sequence_with_dupes_hit", 1)
        self.post_event("event_1")
        self.machine_run()
        self.assertEventCalled("sequence_with_dupes_hit", 1)

    def test_sequence_with_duplicates_2(self):
        self.mock_event("sequence_with_dupes2_hit")
        self.post_event("event_4")
        self.machine_run()
        self.post_event("event_4")
        self.machine_run()
        self.post_event("event_4")
        self.machine_run()
        self.post_event("event_5")
        self.machine_run()
        self.post_event("event_5")
        self.machine_run()
        self.post_event("event_5")
        self.machine_run()
        self.assertEventCalled("sequence_with_dupes2_hit", 0)
        self.post_event("event_4")
        self.machine_run()
        self.post_event("event_4")
        self.machine_run()
        ...
        self.post_event("event_5")
        self.machine_run()
        self.assertEventCalled("sequence_with_dupes2_hit", 1)
        self.post_event("event_5")
        self.machine_run()
        self.assertEventCalled("sequence_with_dupes2_hit", 1)

    def test_sequence_with_duplicates_and_cancel(self):
        self.mock_event("sequence_with_dupes_and_cancel_hit")
        ...
        self.machine_run()
        self.hit_and_release_switch("switch_5")
        self.assertEventCalled("sequence_with_dupes_and_cancel_hit", 0)
        self.hit_and_release_switch("switch_4")
        self.machine_run()
        self.hit_and_release_switch("switch_4")
        self.machine_run()
        ...
        self.hit_and_release_switch("switch_5")
        self.machine_run()
        self.assertEventCalled("sequence_with_dupes_and_cancel_hit", 1)
        self.hit_and_release_switch("switch_5")
        self.assertEventCalled("sequence_with_dupes_and_cancel_hit", 1)

    def test_sequence_with_duplicates_and_cancel2(self):
        self.mock_event("sequence_with_dupes_and_cancel2_hit")
        self.hit_and_release_switch("switch_4")
        self.machine_run()
        self.hit_and_release_switch("switch_4")
        self.machine_run()
        ...
        self.machine_run()
        self.hit_and_release_switch("switch_5")
        self.assertEventCalled("sequence_with_dupes_and_cancel2_hit", 0)
        self.hit_and_release_switch("switch_4")
        self.machine_run()
        self.hit_and_release_switch("switch_5")
        self.machine_run()
